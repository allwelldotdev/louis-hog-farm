...
export type UserCreateStaff = S['UserCreateStaff']
export type UserRoleUpdate = S['UserRoleUpdate']
...
export type HogCreate = S['HogCreate']
export type HogUpdate = S['HogUpdate']
